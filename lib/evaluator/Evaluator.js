...
class Evaluator {
  constructor(grammar, context, relativeContext, options, promise = Promise) {
    ...
    const ignoreNotDefinedVariables = options
      ? options.ignoreNotDefinedVariables
      : undefined
    this._ignoreNotDefinedVariables =
      typeof ignoreNotDefinedVariables === 'undefined'
        ? true
        : ignoreNotDefinedVariables
  ...
  _filterRelative(subject, expr) {
    ...
    subject.forEach((elem) => {
      const evalInst = new Evaluator(
        ...
        elem,
        {
          ignoreNotDefinedVariables: this._ignoreNotDefinedVariables,
