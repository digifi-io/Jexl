...
class Jexl {
   ...
   */
  createExpression(expression, ast, options) {
    return new Expression(this._grammar, expression, ast, options)
  }
  ...
  eval(expression, context = {}, options = {}) {
    const exprObj = this.createExpression(expression, undefined, options)
   ...
   * @param {string} expressionStr The Jexl expression to be evaluated
   ...
   * @returns {Promise<*>} resolves with the result of the evaluation.
   */
  evalPreCompiled(expressionStr, ast, context = {}, options = {}) {
    const expression = this.createExpression(expressionStr, ast, options)
   ...
   * @throws {*} on error
   */
  evalSyncPreCompiled(expressionStr, ast, context = {}, options = {}) {
    const expression = this.createExpression(expressionStr, ast, options)
  ...
  findTokensByAstAndTypes(ast, tokenTypes) {
    return Parser.findTokensByAstAndTypes(ast, tokenTypes, true)
  }
